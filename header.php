...
<head>
    ...
    <title>Cípőbazár - Prémium lábbelik</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <!-- Dokumentáció gomb -->
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/leventeilles028/cipobazar2025mateszalka" target="_blank">
                            <i class="fas fa-book me-1"></i>Dokumentáció
                        </a>
                    </li>
                    
                    <!-- KOSÁR IKON - MINDENKINEK, ID-VAL A JAVÍTÁSHOZ, KEZDETBEN REJTVE -->
                    <li class="nav-item">
