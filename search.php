...
$totalStmt = $pdo->prepare("SELECT COUNT(*) FROM shoes WHERE name LIKE ? OR description LIKE ?");
$totalStmt->execute([$searchParam, $searchParam]);
$total = $totalStmt->fetchColumn();
$totalPages = ceil($total / $limit);

// Találatok lekérése
$stmt = $pdo->prepare("SELECT * FROM shoes WHERE name LIKE :search OR description LIKE :search ORDER BY created_at DESC LIMIT :limit OFFSET :offset");
